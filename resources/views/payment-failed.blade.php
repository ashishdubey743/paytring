         ...
         <div class="layout optimizedCheckout-contentPrimary">
            <div class="layout-main">
               <div class="orderConfirmation">
                  <h1 class="optimizedCheckout-headingPrimary" data-test="order-confirmation-heading">Hi, {{ $order->billing_address->first_name }}!</h1>
                  <section class="orderConfirmation-section">
                     <p data-test="order-confirmation-order-number-text"><span>Your Payment for order number <strong>{{ $order->id }}</strong> is failed. If you have any questions about your purchase, email us at </span></p>
                     <p data-test="order-confirmation-order-status-text"><span><a target="_top" href="mailto:karrar82001@gmail.com?Subject=Order 153">karrar82001@gmail.com</a>.</span></p>
                  </section>
